...
public class MoveBehaviour : GenericBehaviour
{
    ...
    void Start()
    {
        ...
        transform.position = data.GetData<Vector3Type>("Data", "Player", "Position").Value;
    }
    ...
    public override void LocalFixedUpdate()
    {
        ...
        {
            behaviourManager.GetAnim.SetBool("moving", true);
        }
        else
        {
            behaviourManager.GetAnim.SetBool("moving", false);
        }

        data.SetData<Vector3Type>("Data", "Player", "Position", new Vector3Type(transform.position)); 
